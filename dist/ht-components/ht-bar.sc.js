...
class Bar extends LazyLoadedComponent {
    constructor() {
        super(...arguments);
    ...
    static get style() { return "[data-ht-bar-host] {\n  position: relative;\n  display: block;\n  font-size: 1em;\n  line-height: 1em; }\n\ntable[data-ht-bar] {\n  table-layout: fixed;\n  width: 100%;\n  border-spacing: 0;\n  overflow: hidden; }\n\ntd[data-ht-bar] {\n  height: calc(1em + 0.25em);\n  padding: 1px;\n  vertical-align: middle; }\n\ntd.bar-level[data-ht-bar] {\n  background-color: var(--bar-level-background, #A9A9A9);\n  color: var(--bar-max-background, #ECECEC);\n  position: relative;\n  text-align: start; }\n\ntd.bar-level.maxed[data-ht-bar] {\n  background-color: var(--bar-capped-background, #FFEB99);\n  color: var(--bar-level-background, #A9A9A9); }\n\ntd.bar-cap[data-ht-bar] {\n  background-color: var(--bar-cap-background, #CACACA);\n  color: var(--bar-max-background, #ECECEC);\n  text-align: start; }\n\ntd.bar-max[data-ht-bar] {\n  background-color: var(--bar-max-background, #ECECEC);\n  color: var(--bar-level-background, #A9A9A9); }\n\n.title[data-ht-bar] {\n  color: var(--bar-title-color, #000000);\n  white-space: nowrap;\n  position: absolute;\n  top: 2px; }\n  [denomination][data-ht-bar-host]   .title[data-ht-bar] {\n    width: 80px;\n    overflow: hidden; }\n  [dir=ltr][data-ht-bar-host]   .title[data-ht-bar], [dir=ltr]   [data-ht-bar-host]   .title[data-ht-bar] {\n    left: 2px; }\n  [dir=rtl][data-ht-bar-host]   .title[data-ht-bar], [dir=rtl]   [data-ht-bar-host]   .title[data-ht-bar] {\n    right: 2px; }\n\n.number[data-ht-bar] {\n  display: inline-block;\n  margin-left: 5px;\n  margin-right: 5px;\n  white-space: nowrap; }\n\ntd.bar-level[data-ht-bar]   .number[data-ht-bar] {\n  position: absolute;\n  top: 2px; }\n  [dir=ltr][data-ht-bar-host]   td.bar-level[data-ht-bar]   .number[data-ht-bar], [dir=ltr]   [data-ht-bar-host]   td.bar-level[data-ht-bar]   .number[data-ht-bar] {\n    right: 0; }\n  [dir=rtl][data-ht-bar-host]   td.bar-level[data-ht-bar]   .number[data-ht-bar], [dir=rtl]   [data-ht-bar-host]   td.bar-level[data-ht-bar]   .number[data-ht-bar] {\n    left: 0; }\n\n.level-text-dont-fit[data-ht-bar]   .bar-cap[data-ht-bar] {\n  color: var(--bar-max-background, #ECECEC); }\n\n.level-text-dont-fit[data-ht-bar]   .bar-max[data-ht-bar] {\n  color: var(--bar-cap-background, #CACACA); }\n\n.level-text-dont-fit.has-cap-bar.bar-max[data-ht-bar] {\n  color: var(--bar-level-background, #A9A9A9); }\n\n.level-text-dont-fit[data-ht-bar]   .number[data-ht-bar] {\n  position: absolute;\n  top: 2px; }\n  [dir=ltr][data-ht-bar-host]   .level-text-dont-fit[data-ht-bar]   .number[data-ht-bar], [dir=ltr]   [data-ht-bar-host]   .level-text-dont-fit[data-ht-bar]   .number[data-ht-bar] {\n    right: 0; }\n  [dir=rtl][data-ht-bar-host]   .level-text-dont-fit[data-ht-bar]   .number[data-ht-bar], [dir=rtl]   [data-ht-bar-host]   .level-text-dont-fit[data-ht-bar]   .number[data-ht-bar] {\n    left: 0; }\n\n.denomination[data-ht-bar] {\n  position: absolute;\n  color: var(--bar-denomination-color, #000000);\n  white-space: nowrap;\n  top: 2px; }\n  [dir=ltr][data-ht-bar-host]   .denomination[data-ht-bar], [dir=ltr]   [data-ht-bar-host]   .denomination[data-ht-bar] {\n    left: 85px; }\n  [dir=rtl][data-ht-bar-host]   .denomination[data-ht-bar], [dir=rtl]   [data-ht-bar-host]   .denomination[data-ht-bar] {\n    right: 85px; }"; }
}
/**
