...
class Avatar extends LazyLoadedComponent {
    constructor() {
        super(...arguments);
    ...
    static get style() { return "[data-ht-avatar-host] {\n  position: relative;\n  display: inline-block;\n  width: calc(92px * var(--avatar-size, 1));\n  height: calc(123px * var(--avatar-size, 1)); }\n\n.ht-avatar-has-facecard[data-ht-avatar-host] {\n  width: calc(110px * var(--avatar-size, 1));\n  height: calc(155px * var(--avatar-size, 1)); }\n\n.ht-avatar-round[data-ht-avatar-host], .ht-avatar-square[data-ht-avatar-host] {\n  height: calc(92px * var(--avatar-size, 1)); }\n\n.ht-avatar-has-facecard.ht-avatar-round[data-ht-avatar-host], .ht-avatar-has-facecard.ht-avatar-square[data-ht-avatar-host] {\n  height: calc(110px * var(--avatar-size, 1)); }\n\ndiv[data-ht-avatar] {\n  position: relative;\n  overflow: hidden;\n  width: 100%;\n  height: 100%; }\n  .ht-avatar-round[data-ht-avatar-host]   div[data-ht-avatar] {\n    border-radius: 100%; }\n\nimg[data-ht-avatar] {\n  position: absolute; }"; }
}
