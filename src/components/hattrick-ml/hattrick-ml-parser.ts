...
export class HattrickMlParser {
  ...
  private removeNonVisibleBrs(input: string): string {
    // TODO: I was here, try removing the ? again and fixing the \s
          ...
          switch (tag.toLowerCase()) {
            case "img":
              if (allowCustomContent) {
                ...
                let styleAttr = Object.keys(styles)
                  .map((x) => `${x}:${styles[x]}`)
                  .join(";");
                ...
                str = str.replace(
                  match,
                  `<img src="${text}" style="${styleAttr}" class="${classAttr}" />`,
                );
              } else {
            ...
            case "link":
              if (id) {
                ...
                url = this.xss(url);
                if (!allowCustomContent || !text)
                  text = `(${this.truncateLinkText(id)})`;

                str = str.replace(
                  match,
                  HattrickMlParser.replacer.getLink(url, text),
                );
              } else {
                str = str.replace(
                  match,
                  match.replace("[", "&lbrack;").replace("]", "&rbrack;"),
                ); // replace brackets
              }
              break;
            case "youtube":
            ...
            case "quote":
              if (id) {
                str = str.replace(
                  match,
                  `<blockquote class="quote"><b>${id}:</b><br />${text}</blockquote>`,
                );
              } else {
                str = str.replace(
                  match,
            ...
            case "playerid":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getPlayerId(id, text),
              );
              break;
            case "teamid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getTeamId(id, text),
              );
              break;
            case "ntteamid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getNtTeamId(id, text),
              );
              break;
            case "userid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getUserId(id, text),
              );
              break;
            case "matchid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getMatchId(id, text),
              );
              break;
            ...
            case "arenamatchid":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getTournamentMatchId(id, text),
              );
              break;
            case "leagueid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getLeagueId(id, text),
              );
              break;
            case "youthteamid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getYouthTeamId(id, text),
              );
              break;
            case "youthplayerid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getYouthPlayerId(id, text),
              );
              break;
            case "youthmatchid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getYouthMatchId(id, text),
              );
              break;
            case "youthleagueid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getYouthLeagueId(id, text),
              );
              break;
            case "post":
            case "message":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getPost(post[0], post[1], text),
              );
              break;
            case "spoiler":
              let spoilerText = (this.spoilerText || "")
                .replace("[link]", "")
                .replace("[/link]", "");
            ...
            case "articleid":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getArticleId(id, text),
              );
              break;
            case "allianceid":
            case "federationid":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getFederationId(id, text),
              );
              break;
            case "tournamentid":
            case "arenacontestid":
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getTournamentId(id, text),
              );
              break;
            case "kitid":
              id = this.xss(id);
              ...
              str = str.replace(
                match,
                HattrickMlParser.replacer.getKitId(id, text),
              );
              break;
            case "table":
              ...
              str = str.replace(
                match,
                `<table class="htMlTable">${text}</table>`,
              );
              break;
            case "money":
...
const TAGS = {
  b: {
    ...
    canHaveContent: true,
    requireId: false,
    url: "/images/forum-tags/bold.png",
  },
  i: {
    name: "italic",
    tag: "i",
    canHaveContent: true,
    requireId: false,
    url: "/images/forum-tags/italic.png",
  },
  u: {
    name: "underline",
    tag: "u",
    canHaveContent: true,
    requireId: false,
    url: "/images/forum-tags/underline.png",
  },
  q: {
    name: "quote",
    tag: "q",
    canHaveContent: true,
    requireId: undefined,
    url: "/images/forum-tags/quote.png",
  }, // requireId = undefined => can have, but isn't required.
  quote: {
    name: "quote",
    tag: "quote",
    canHaveContent: true,
  ...
  playerid: {
    ...
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/player.png",
  },
  youthplayerid: {
    name: "youthplayerid",
    tag: "youthplayerid",
  ...
  matchid: {
    ...
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/match.png",
  },
  youthmatchid: {
    name: "youthmatchid",
    tag: "youthmatchid",
  ...
  teamid: {
    ...
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/team.png",
  },
  youthteamid: {
    name: "youthteamid",
    tag: "youthteamid",
  ...
  post: {
    ...
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/post.png",
  },
  message: {
    name: "post",
    tag: "message",
  ...
  federationid: {
    ...
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/federation.png",
  },
  link: {
    name: "link",
    tag: "link",
    canHaveContent: false,
    requireId: true,
    url: "/images/forum-tags/link.png",
  },
  userid: {
    name: "userid",
    tag: "userid",
