...
import { Gesture, GestureDetail } from "../../ionic/gesture";
import { StyleEventDetail } from "../../interface";
import { clamp, debounceEvent, renderHiddenInput } from "../../ionic/helpers";
...
export class Range implements ComponentInterface {
  ...
  @Element() el!: HTMLHattrickRangeElement;
  ...
  async componentDidLoad() {
    ...
    if (rangeSlider) {
      this.gesture = (await import("../../ionic/gesture")).createGesture({
        el: rangeSlider,
        gestureName: "range",
        gesturePriority: 100,
        threshold: 0,
